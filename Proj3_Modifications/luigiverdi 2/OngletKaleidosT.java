...
public class OngletKaleidosT extends OngletKaleidos{
	...
	void initHaut()
	{
		...
		this.textHaut = new JLabel("Affichage du kaleidos transpose", JLabel.CENTER);
		this.boutonComplet = new JButton("Affichage du kaleidos transpose complet");
		this.boutonPartiel = new JButton("Affichage du kaleidos transpose partiel");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			this.textHaut.setText("Affichage du kaleidos transpose");
			this.completeHaut();
		...
		else if (src == this.boutonPartiel)
		{
			if (this.jtfPartiel.getText().matches("^([0-9]|10|11)( ([0-9]|10|11))*$")) // si le format de l'entree est bon
			{
				...
				this.affPartiel(tab);
				this.zoneAffichage.repaint();
				this.textHaut.setText("Affichage partiel du kaleidos transpose");
				this.completeHaut();
